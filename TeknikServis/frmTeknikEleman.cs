...
{
    public partial class frmTeknikEleman : Form
    {
        ...
        private void frmTeknikEleman_Load(object sender, EventArgs e)
        {
            //Ana menüler(kart menüler) oluşturma
            pnlTeknikServisEleman te = new pnlTeknikServisEleman();
            te._frmTeknikEleman = this;
            pnlTeknikElemenTemp.Controls.Add(te);
        ...
        //form kapanırken
        private void frmTeknikEleman_FormClosing(object sender, FormClosingEventArgs e)
        {
