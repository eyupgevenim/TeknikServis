...
{
    public partial class frmSatisEleman : Form
    {
        ...
        private void frmSatisEleman_Load(object sender, EventArgs e)
        {
            //Ana menüler(kart menüler) oluşturma
            pnlSatisElemaniAnaMenu se = new pnlSatisElemaniAnaMenu();
            se._frmSatisEleman = this;
            pnlSatisElemenTemp.Controls.Add(se);
        ...
        //form kapanırken
        private void frmSatisEleman_FormClosing(object sender, FormClosingEventArgs e)
        {
