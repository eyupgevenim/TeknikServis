...
{
    public partial class pnlSiparisBasla : UserControl
    {
        public DataTable t;
       Image sil=Image.FromFile("..\\..\\img\\sil24x24.png");

        public pnlSiparisBasla()
        {
            InitializeComponent();
        }

        //panel yüklendiğinde
        private void pnlSiparisBasla_Load(object sender, EventArgs e)
        {
            t = new DataTable();
            ...
            cBox_katagori.SelectedIndexChanged +=
                new EventHandler(cBox_katagori_SelectedIndexChanged);
            cBox_marka.SelectedIndexChanged +=
